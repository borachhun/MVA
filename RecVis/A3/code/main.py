...
def main():
    ...
    # Same with data_transforms, just added flipping
    data_transforms_reflection = transforms.Compose([
        transforms.Resize((224, 224)),
    ...
    train_loader = torch.utils.data.DataLoader(
        torch.utils.data.ConcatDataset([
            ...
            datasets.ImageFolder(args.data + "/train_images", transform=data_transforms_reflection) # Data augmentation: horizontal reflection
        ]),
